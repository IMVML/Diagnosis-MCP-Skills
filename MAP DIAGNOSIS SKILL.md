# A10 - Coworker skill: NORDVELL abandonment diagnosis

**Owner: Ivan.** CX Coworker installs instructions as **skills**, so this is written to be pasted
into a skill definition.

A skill normally has three parts: a **name**, a **description** that decides when it fires, and the
**instructions** themselves. Field names vary; map these onto whatever Coworker's form calls them.
...
```
NORDVELL abandonment diagnosis
```
